...
<h1>Nouveau Pseudo</h1>
    ...
    <form action="index.php?action=updatePseudo&id=<?= $_SESSION['id'] ?>" method="POST">
        <?php if (isset($erreur)):
                if($erreur): 
                    foreach($erreur as $e):
                    ?>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="oldPseudo" id="oldPseudo" value="<?= $_SESSION['pseudo'] ?>" readonly="readonly" required />
        </div>
        <div class="form-group">
