                ...
                <form method="POST" action="contactPost#contact">
                    <div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            ...
                            <input type="text" class="form-control" placeholder="Nom" id="nom" name="nom"
                                value="<?php if(isset($nom)) echo htmlspecialchars($nom) ?>" required
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            ...
                            <input type="text" class="form-control" placeholder="Prenom" id="prenom" name="prenom"
                                value="<?php if(isset($prenom)) echo htmlspecialchars($prenom) ?>" required
                                data-validation-required-message="Please enter your name.">
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            ...
                            <input type="email" class="form-control" placeholder="Confirmation Email" id="confirmEmail"
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            ...
                            <input type="text" class="form-control" placeholder="objet" id="objet" name="objet" required
