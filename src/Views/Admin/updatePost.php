    ...
    <div class="container text-center">
        ...
        <form method="POST" action="updatePost&id=<?= $post->getId(); ?>">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="chapo" id="chapo" cols="30"
                    rows="10"><?= $post->getChapo(); ?></textarea>
            </div>
            <div class="form-group">
                <label for="contenu">Contenu : </label>
                <textarea class="form-control" name="contenu" id="contenu" cols="60"
                    rows="10"><?= $post->getContenu(); ?></textarea>
            </div>
